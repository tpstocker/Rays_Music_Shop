...
public class Trumpet extends Instrument implements IPlay, ISell {
    ...
    public Trumpet(double buyPrice, double sellPrice, int stockId, double markup, Brand brand, Colour colour, Material material, Type type, String sound, String subType) {
